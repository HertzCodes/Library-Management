...
class Homepage_Owner(home_page.Homepage_main):
    ...
    def side_bar(self):
        # open icons
        user_icon = ctk.CTkImage(dark_image=Image.open("gui/media/home_page/users.png"), size=(30, 30))
        bookstore_icon = ctk.CTkImage(dark_image=Image.open("gui/media/home_page/bookstore.png"), size=(30, 30))
        admin_panel_icon = ctk.CTkImage(dark_image=Image.open("gui/media/home_page/admin_panel.png"), size=(30, 30))
        ...
        self.side_user_icon = ctk.CTkButton(self.side_bar_frame, image=user_icon,
                                            text=None, width=30, height=30, fg_color='white', corner_radius=10)
        self.side_user_icon.place(x=0, y=160)
        ...
        self.side_admin_pannel_icon = ctk.CTkButton(self.side_bar_frame, image=admin_panel_icon,
                                                    text=None, width=30, height=30, fg_color='white', corner_radius=10)
        self.side_admin_pannel_icon.place(x=0, y=240)

        self.side_question_icon = ctk.CTkButton(self.side_bar_frame, image=question_icon,
                                            text=None, width=30, height=30, fg_color='white', corner_radius=10)
        self.side_question_icon.place(x=0, y=610)
    ...
    def side_bar_toggle(self):
        ...
        self.side_user_icon.configure(text = 'Users', font=("nunito sans", 10, 'bold'), text_color='black', width=192)
        self.side_bookstore_icon.configure(text = 'Book store', font=("nunito sans", 10, 'bold'), text_color='black', width=192)
        self.side_admin_pannel_icon.configure(text = 'Admin pannel', font=("nunito sans", 10, 'bold'), text_color='black', width=192)
    ...
    def close_side_bar(self):
        ...
        self.side_user_icon.configure(width=30)
        self.side_bookstore_icon.configure(width=30)
        self.side_admin_pannel_icon.configure(width=30)
